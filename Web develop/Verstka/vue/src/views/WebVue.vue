<template>
    ...
    <body>
        <div class="wrap">
            <nav class="menu">
                <div class="menu-left">
                    <button class="menu-left-logo">
                        <svg width="44" height="38" viewbox="0 0 44 38">
                            <rect width="44" height="38" fill="url(#pattern0_128_53)" />
                            <defs>
                                <pattern id="pattern0_128_53" patternContentUnits="objectBoundingBox" width="1"
                                    height="1">
                    ...
                    <button class="menu-left-search"> <svg viewbox="0 0 26 27" width="26" height="26">
                            <path
                ...
                <div class="menu-right">
                    <button class="menu-right-burger"><svg width="32" height="23" viewbox="0 0 32 23">
                            <path d="M0 23V20.31H32V23H0ZM0 12.76V10.07H32V12.76H0ZM0 2.69V0H32V2.69H0Z"
                                fill="#E8E8E8" />
                        </svg></button>
                    <button class="menu-right-account"><svg width="29" height="29" viewbox="0 0 29 29">
                            <path
            ...
            <footer class="footer">
                ...
                <div class="footer-cprgt">
                    ...
                    <div class="footer-cprgt-socials">
                        ...
                        <button class="footer-cprgt-socials-icon"><img src="/img/twit.png"></button>
                        <button class="footer-cprgt-socials-icon"><img src="/img/pint.png"></button>
                    </div>
                </div>
            </footer>
        </div>
